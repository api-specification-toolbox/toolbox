...
description: <p>Azure Container Service optimizes the configuration of popular open-source
...
x-rank: "10"
x-alexaRank: "33"
url: http://api.specificationtoolbox.com/resources/service-providers/azure-container-service/
tags:
- Microsoft
- Deployment
- Containers
...
- type: x-white-papers
  url: https://aka.ms/securingk8s-whitepaper
- type: x-youtube
