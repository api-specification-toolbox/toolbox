...
description: <p>Amazon ElastiCache is a web service that makes it easy to deploy,
  operate, and scale an in-memory data store or cache in the cloud. The service improves
...
x-common:
- type: x-case-studies
  url: https://aws.amazon.com/solutions/case-studies/Peloton/
- type: x-case-studies
...
- type: x-documentation
  url: https://aws.amazon.com/documentation/elasticache/
- type: x-facebook
...
- type: x-youtube
  url: https://www.youtube.com/watch?v=eyd_8efUCwM
include: []
maintainers:
- FN: Kin Lane
