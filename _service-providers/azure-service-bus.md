...
description: <p>Depend on Azure Service Bus when you need highly-reliable cloud messaging
...
x-rank: "10"
x-alexaRank: "33"
url: http://api.specificationtoolbox.com/resources/service-providers/azure-service-bus/
tags:
- Relative Data
- Microsoft
- Have API Paths
