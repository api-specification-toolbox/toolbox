...
description: <p>AWS Device Farm is an app testing service that lets you test and interact
...
x-rank: "10"
x-alexaRank: "14"
url: http://api.specificationtoolbox.com/resources/service-providers/aws-device-farm/
tags:
- Relative Data
- Have API Paths
- Have API
