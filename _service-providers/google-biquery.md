---
name: Google Biquery
description: <p>BigQuery is Google's fully managed, petabyte scale, low cost enterprise
  data warehouse for analytics. BigQuery is serverless. There is no infrastructure
  to manage and you don't need a database administrator, so you can focus on analyzing
...
- type: x-documentation
  url: https://cloud.google.com/bigquery/docs/schemas
- type: x-documentation
...
- type: x-documentation
  url: https://cloud.google.com/bigquery/docs/reference/
- type: x-documentation
  url: https://cloud.google.com/bigquery/docs/resources
- type: x-documentation
  url: https://cloud.google.com/bigquery/docs/custom-quotas/
- type: x-documentation
...
- type: x-pricing
  url: https://cloud.google.com/bigquery/bqml-pricing
- type: x-pricing
  url: https://cloud.google.com/bigquery/pricing
- type: x-quotas
...
- type: x-tutorials
  url: https://cloud.google.com/docs/tutorials#bigquery
- type: x-tutorials
...
- type: x-youtube
  url: https://www.youtube.com/watch?v=eyBK9nj-7AA&autoplay=1
- type: x-youtube
  url: https://www.youtube.com/watch?v=yL8gDnbgXOc&autoplay=1
include: []
maintainers:
- FN: Kin Lane
