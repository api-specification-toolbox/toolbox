...
description: <p><span>AWS Service Catalog allows organizations to create and manage
  ...
  to complete multi-tier application architectures. AWS Service Catalog allows you
