...
description: <p>Google Cloud DNS is a scalable, reliable and managed authoritative
  Domain Name System (DNS) service running on the same infrastructure as Google. It
  has low latency, high availability and is a cost-effective way to make your applications
...
x-rank: "9"
x-alexaRank: "1"
url: http://api.specificationtoolbox.com/resources/service-providers/google-cloud-dns/
tags:
- Relative Data
- Have API Paths
- Have API
...
- type: x-developer
  url: https://cloud.google.com/dns/api/v1/
