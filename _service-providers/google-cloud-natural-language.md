...
description: <p>Google Cloud Natural Language API reveals the structure and meaning
...
- type: x-customers
  url: https://cloud.google.com/customers/hearst-newspapers/
- type: x-customers
  url: https://cloud.google.com/customers/meredith/
- type: x-customers
