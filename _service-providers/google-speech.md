---
name: Google Speech
description: <p>Google Cloud Speech API enables developers to convert audio to text
...
- type: x-youtube
  url: https://www.youtube.com/watch?v=71jzm19xn4U&autoplay=1
include: []
maintainers:
- FN: Kin Lane
