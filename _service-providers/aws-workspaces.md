---
name: AWS WorkSpaces
description: <p>Amazon WorkSpaces is a fully managed, secure desktop computing service
...
x-rank: "10"
x-alexaRank: "14"
url: http://api.specificationtoolbox.com/resources/service-providers/aws-workspaces/
tags:
- Relative Data
- Have API Paths
- Have API
