---
name: AWS OpsWorks
description: <p><span>AWS OpsWorks is a configuration management service that uses
  Chef, an automation platform that treats server configurations as code. OpsWorks
...
x-rank: "10"
x-alexaRank: "14"
url: http://api.specificationtoolbox.com/resources/service-providers/aws-opsworks/
tags:
- Relative Data
- Orchestration
- Have API Paths
