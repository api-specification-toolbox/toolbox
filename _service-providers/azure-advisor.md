---
name: Azure Advisor
description: <p><span>Azure Advisor is a personalized recommendation engine that helps
...
x-rank: "10"
x-alexaRank: "33"
url: http://api.specificationtoolbox.com/resources/service-providers/azure-advisor/
tags:
- Relative Data
- Performance
- Microsoft
...
- type: x-documentation
  url: https://docs.microsoft.com/en-us/rest/api/advisor/
- type: x-documentation
...
- type: x-feed
  url: https://aka.ms/advisorfeedback
- type: x-feed
...
- type: x-youtube
  url: https://www.youtube.com/watch?v=VNKYsBQYKH8
- type: x-youtube
