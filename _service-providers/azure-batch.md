---
name: Azure Batch
description: <p>Batch processing began with mainframe computers and punch cards. Today,
...
x-rank: "10"
x-alexaRank: "33"
url: http://api.specificationtoolbox.com/resources/service-providers/azure-batch/
tags:
- Relative Data
- Microsoft
- Have API Paths
...
- type: x-documentation
  url: https://docs.microsoft.com/en-us/rest/api/batchservice
- type: x-events
...
- type: x-forum
  url: https://feedback.azure.com/forums/269742-azure-batch
- type: x-linkedin
