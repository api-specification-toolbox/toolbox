...
description: <p>Cloud Datastore is a highly-scalable NoSQL database for your applications.
...
x-rank: "9"
x-alexaRank: "1"
url: http://api.specificationtoolbox.com/resources/service-providers/google-cloud-datastore/
tags:
- Relative Data
- Have API Paths
- Have API
...
- type: x-getting-started
  url: https://cloud.google.com/datastore/docs/quickstart
- type: x-github
  url: https://github.com/objectify/objectify
- type: x-guides
...
- type: x-youtube
  url: https://www.youtube.com/watch?v=rRoy6I4gKWU
include: []
maintainers:
- FN: Kin Lane
